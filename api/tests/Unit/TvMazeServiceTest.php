...
class TvMazeServiceTest extends TestCase
{
    ...
    {
        // Mock the FetchTvMazeSearchShowAction to return a collection
    ...
    public function testFilterUniqShowByRequest()
    {
        ...
        $results = $this->getSampleApiResponse();
    ...
    private function getSampleApiResponse(): Collection
    {
        return collect([
            [
                'score' => 0.9081737,
        ...
        ])->map(fn($item) => TvShowDTO::from($item));
    }
